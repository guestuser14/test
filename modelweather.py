...
weather_df = pd.read_csv('punetest.csv', parse_dates=['date_time'], index_col='date_time')
weather_df.head(5)
...
# Ensure the datetime index is preserved
...
print(weather_df_num.index)

# Now slice the DataFrame based on date range '2019':'2020'
